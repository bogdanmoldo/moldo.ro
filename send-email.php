<?php 
 ...
 $from=$_POST["email"];
 $msg=$_POST["message"];
 $receiver="bogdanmoldo@icloud.com";
 $subject="Message sent via Moldo.ro!";
...
<table width='50%' border='0' align='center' cellpadding='0' cellspacing='0'>
  <tr>
    <td colspan='2' align='center' valign='top'><img src='http://moldo.ro/images/logo.png' width='140' height='200'></td>
  </tr>
  <tr>
